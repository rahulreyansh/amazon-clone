...
function Home({ title, price, rating, image }) {
  return (
    <div className={classes.home}>
      <div className="home__container">
        ...
        <div className={classes.home__row}>
          ...
          <Product
            id={Math.random}
            title="Xiaomi 12 Pro | 5G (Couture Blue, 8GB RAM, 256GB Storage) | Snapdragon 8 Gen 1 | 50MP+50MP+50MP Flagship Cameras(OIS) | 10 bit 2K+ AMOLED Display | Get 3 Months of YouTube Premium Free!"
            price={62999}
            rating={5}
